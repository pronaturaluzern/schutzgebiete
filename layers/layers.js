...
var group_SchutzgebieteSchutzverordnungen = new ol.layer.Group({
                                layers: [lyr_SchutzgebieteProNaturaLuzern_2,lyr_SchutzgebieteProNaturaLuzern_3,],
                                fold: 'open',
...
lyr_CartoLight_0.setVisible(true);lyr_tlm_kantonsgebiet_1.setVisible(true);lyr_SchutzgebieteProNaturaLuzern_2.setVisible(true);lyr_SchutzgebieteProNaturaLuzern_3.setVisible(true);
...
lyr_SchutzgebieteProNaturaLuzern_3.set('fieldAliases', {'fid': 'fid', 'Schutzgebiet': 'Schutzgebiet', 'link': 'link', });
